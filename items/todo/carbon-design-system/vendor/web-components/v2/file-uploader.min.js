...
`),n,o,d,t,s)}},{kind:"get",static:!0,key:"selectorUploaderItem",value:function(){return`${s}-file-uploader-button,${s}-file-uploader-drop-container`}},{kind:"field",static:!0,key:"styles",value:()=>y}]}}),o),function(e){e.UPLOADING="uploading",e.COMPLETE="complete",e.EDIT="edit"}(k||(k={})),function(e){e.SMALL="sm",e.MEDIUM="md",e.LARGE="lg"}(_||(_={}));let w,$,q,S=e=>e;t([d(`${s}-file-uploader-item`)],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"method",key:"_handleClickDeleteButton",value:function(){const e={bubbles:!0,cancelable:!0,composed:!0},{eventBeforeDelete:t,eventDelete:o}=this.constructor;this.dispatchEvent(new CustomEvent(t,e))&&this.dispatchEvent(new CustomEvent(o,e))}},{kind:"method",key:"_renderEditing",value:function(){const{iconDescription:e,invalid:t,_handleClickDeleteButton:o}=this;return i(w||(w=S`
  ${0}
  <button
    type="button"
    aria-label="${0}"
...
`),t?l({class:`${s}--file-invalid`}):void 0,e,s,o,a())}},{kind:"method",key:"_renderUploading",value:function(){const{iconDescription:e}=this;return i($||($=S`
  <cds-loading
    assistive-text="${0}"
    type="${0}"></cds-loading>
`),e,p.SMALL)}},{kind:"method",key:"_renderUploaded",value:function(){const{iconDescription:e}=this;return c({class:`${s}--file-complete`,"aria-label":e})}},{kind:"method",key:"_renderStatus",value:function(){const{state:e}=this;switch(e){case k.EDIT:return this._renderEditing();case k.UPLOADING:return this._renderUploading();case k.COMPLETE:return this._renderUploaded();default:return}}},{kind:"field",decorators:[n({attribute:"icon-description"})],key:"iconDescription",value:()=>"Delete this file"},{kind:"field",decorators:[n({type:Boolean,reflect:!0})],key:"invalid",value:()=>!1},{kind:"field",decorators:[n({reflect:!0})],key:"size",value:()=>_.MEDIUM},{kind:"field",decorators:[n({reflect:!0})],key:"state",value:()=>k.UPLOADING},{kind:"field",decorators:[n({attribute:"error-subject"})],key:"errorSubject",value:()=>""},{kind:"field",decorators:[n({attribute:"error-body"})],key:"errorBody",value:()=>""},{kind:"method",key:"render",value:function(){const{invalid:e,errorSubject:t,errorBody:o}=this;return i(q||(q=S` <p class="${0}--file-filename"><slot></slot></p>
  ...
  </div>`),s,s,this._renderStatus(),s,!e&&!t,s,t,s,!o,o)}},{kind:"get",static:!0,key:"eventBeforeDelete",value:function(){return`${s}-file-uploader-item-beingdeleted`}},{kind:"get",static:!0,key:"eventDelete",value:function(){return`${s}-file-uploader-item-deleted`}},{kind:"field",static:!0,key:"styles",value:()=>y}]}}),o);let j,B=e=>e;const M={dragover:"copy",dragleave:"move"};t([d(`${s}-file-uploader-drop-container`)],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",key:"_active",value:()=>!1},{kind:"method",key:"_handleChange",value:function(e){var t,o;const{eventChange:i,selectorInput:s}=this.constructor,r=this._getFiles(e,(null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(s)).files);this.dispatchEvent(new CustomEvent(i,{bubbles:!0,composed:!0,detail:{addedFiles:r}}));const n=null==this||null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector(s);n&&(n.value="")}},{kind:"method",decorators:[b("dragover"),b("dragleave"),b("drop")],key:"_handleDrag",value:function(e){if(e.preventDefault(),this.disabled)return;const{dataTransfer:t,type:o}=e,i=M[o];t&&i&&(t.dropEffect=i),this._active="dragover"===o,"drop"===o&&this._handleChange(e),this.requestUpdate()}},{kind:"method",key:"_getFiles",value:function(e,t){const{accept:o}=this;if(!o||!/^(change|drop)$/.test(e.type))return Array.from(null!=t?t:[]);const i=new Set(o.split(" "));return Array.prototype.filter.call(t,(({name:e,type:t=""})=>{var o;const s=/\.[^.]+$/,r=s.test(e),[n]=r?null!==(o=s.exec(e))&&void 0!==o?o:[]:[void 0];return i.has(t)||n&&i.has(n)}))}},{kind:"field",decorators:[n()],key:"accept",value:()=>""},{kind:"field",decorators:[n({type:Boolean,reflect:!0})],key:"disabled",value:()=>!1},{kind:"field",decorators:[n({type:Boolean,reflect:!0})],key:"multiple",value:()=>!1},{kind:"field",decorators:[n({reflect:!0})],key:"name",value:()=>""},{kind:"field",decorators:[n({reflect:!0})],key:"slot",value:()=>"drop-container"},{kind:"method",key:"render",value:function(){const{accept:e,disabled:t,multiple:o,name:n,_active:d,_handleChange:c}=this,a=r({[`${s}--file-browse-btn`]:!0,[`${s}--file-browse-btn--disabled`]:t}),l=r({[`${s}--file__drop-container`]:!0,[`${s}--file__drop-container--drag-over`]:d});return i(j||(j=B`
...
`),a,l,v(n),s,v(e),t,o,c)}},{kind:"get",static:!0,key:"eventChange",value:function(){return`${s}-file-uploader-drop-container-changed`}},{kind:"get",static:!0,key:"selectorInput",value:function(){return`.${s}--file-input`}},{kind:"field",static:!0,key:"styles",value:()=>y}]}}),f(o));let F,I=e=>e;t([m(`${s}-file-uploader-button`)],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"method",key:"_handleClick",value:function(e){var t,o;e.target.value=null;const{selectorInput:i}=this.constructor;null==this||null===(t=this.shadowRoot)||void 0===t||null===(t=t.querySelector(i))||void 0===t||t.setAttribute("value",""),(null==this||null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector(i)).click()}},{kind:"method",key:"_handleKeyDown",value:function(e){const{selectorInput:t}=this.constructor;var o,i;"Enter"!==e.key&&"Space"!==e.key||(null==this||null===(o=this.shadowRoot)||void 0===o||null===(o=o.querySelector(t))||void 0===o||o.setAttribute("value",""),(null==this||null===(i=this.shadowRoot)||void 0===i?void 0:i.querySelector(t)).click())}},{kind:"method",key:"_handleChange",value:function(e){var t;const o=this._getFiles(e),{eventChange:i,selectorInput:s}=this.constructor;this.dispatchEvent(new CustomEvent(i,{bubbles:!0,composed:!0,detail:{addedFiles:o}}));const r=null==this||null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(s);r&&(r.value="")}},{kind:"method",key:"_getFiles",value:function(e){var t;const{files:o}=null!==(t="drop"===e.type?e.dataTransfer:e.target)&&void 0!==t?t:{},{accept:i}=this;if(!i||!/^(change|drop)$/.test(e.type))return Array.from(null!=o?o:[]);const s=new Set(i.split(" "));return Array.prototype.filter.call(o,(({name:e,type:t=""})=>{var o;const i=/\.[^.]+$/,r=i.test(e),[n]=r?null!==(o=i.exec(e))&&void 0!==o?o:[]:[void 0];return s.has(t)||n&&s.has(n)}))}},{kind:"field",decorators:[n({reflect:!0,attribute:"button-kind"})],key:"buttonKind",value:()=>u.PRIMARY},{kind:"field",decorators:[n({reflect:!0})],key:"size",value:()=>h.MEDIUM},{kind:"field",decorators:[n()],key:"accept",value:()=>""},{kind:"field",decorators:[n({type:Boolean,reflect:!0})],key:"disabled",value:()=>!1},{kind:"field",decorators:[n({type:Boolean,reflect:!0})],key:"multiple",value:()=>!1},{kind:"field",decorators:[n({reflect:!0})],key:"name",value:()=>""},{kind:"field",decorators:[n({reflect:!0})],key:"slot",value:()=>"drop-container"},{kind:"method",key:"render",value:function(){const{accept:e,disabled:t,multiple:o,name:n,buttonKind:d,size:c,_handleChange:a}=this,l=r({[`${s}--file-browse-btn`]:!0,[`${s}--file-browse-btn--disabled`]:t}),p=r({[`${s}--btn`]:!0,[`${s}--btn--${d}`]:d,[`${s}--layout--size-${c}`]:c,[`${s}--btn--disabled`]:t,[`${s}--btn--${c}`]:c});return i(F||(F=I`
  <button
    type="button"
    class="${0}"
    @click="${0}"
  ...
  <input
    ...
    name="${0}"
    @change="${0}" />
`),p,this._handleClick,this._handleKeyDown,l,s,v(e),t,o,v(n),a)}},{kind:"get",static:!0,key:"eventChange",value:function(){return`${s}-file-uploader-button-changed`}},{kind:"get",static:!0,key:"selectorInput",value:function(){return`.${s}--file-input`}},{kind:"field",static:!0,key:"styles",value:()=>y}]}}),f(o));let C,D=e=>e;t([m(`${s}-file-uploader-skeleton`)],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"method",key:"render",value:function(){return i(C||(C=D`
  <cds-skeleton-text
    type="${0}"
